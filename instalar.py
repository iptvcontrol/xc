...
rDownloadURL = "https://worldofiptv.com/downloads/xtreamui/install.php?type=%s"
rPackages = ["libcurl3", "libxslt1-dev", "e2fsprogs", "wget", "mcrypt", "nscd", "htop", "mysql-server"]
...
if __name__ == "__main__":
    printc("Xtream Codes Fork Version Spanish", col.OKGREEN, 2)
    rType = raw_input("  Installation Type [MAIN, ADMIN]: ")
    print " "
